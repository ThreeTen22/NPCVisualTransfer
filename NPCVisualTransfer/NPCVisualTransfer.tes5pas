...
begin
  ...
  CopyDirectoryLocal(TempPath+'OverwrittenFaceGens\', DataPath+moDataFolder+'\'+fdate+'\OverwrittenFaceGens\',temp,true);
  CopyDirectoryLocal(TempPath+'TransferredFaceGens\', DataPath+moDataFolder+'\'+fdate+'\TransferredFaceGens\',temp,true);
  temp.free;
end;
...
procedure CopyDirectoryLocal(src, dst: string; ignore: TStringList; verbose: boolean);
var
  i: integer;
  rec: TSearchRec;
  skip: boolean;
